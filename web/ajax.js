...
function mqttsuba(id, base_cnt, endp_cnt){
    ...
    str += "<hr>";
    str += "<p><label class='lf'>Base topic " + (base_cnt+1) + ": </label><input size='20' name='base" + base_cnt + "' class='edit rh' /></p>" ;
    str += "<p><label class='lf'>endpoints: </label><input size='20' name='endpt" + base_cnt + "' class='edit rh' /></p>" ;
    str += "<p class='lf2'>";
